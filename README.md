...
| [N_HideIdleMouse][N_HideIdleMouse]                 | Hides the mouse cursor if it hasn't been moved for a while. | [1.0.3][N_HideIdleMouse_release]           |
...
| [N_TitleMap][N_TitleMap]                           | Renders an ingame map (including events) as title screen.   | [1.1.0][N_TitleMap_release]                |
| [N_WeatherFog][N_WeatherFog]                       | Adds procedurally generated fog weather effect.             | [1.4.4][N_WeatherFog_release]              |
